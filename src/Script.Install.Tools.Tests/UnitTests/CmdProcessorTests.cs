...
namespace Script.Install.Tools.Tests.UnitTests
{
    [TestFixture(Category = "UnitTests")]
    public class CmdProcessorTests
    {
        ...
        void target_StandardOutReceived(object sender, CmdProcessorEventArgs e)
        {
            _logger.Info(e.Text);
        }

        void target_StandardErrorReceived(object sender, CmdProcessorEventArgs e)
        {
            _logger.Error(e.Text);
        }

        void target_ProcessExited(object sender, CmdProcessorEventArgs e)
        {
            _logger.Info(e.Text);            
        }
